            ...
            axios.get('../../../data_user.php', {
                ...
                .then((response) => {
                    ...
                    if (datos.data_course[0].react_progress_object !== "") {
                        ...
                        const porcentajeCalculado = (sum / 28) * 100;
                        ...
                        <div className=" flex justify-center items-center">
                            <button
                                ...
                                (window.location.href =
                                    "https://tecnitanques.sofactia.pro/amatia/audit/1737045090/jAuvKf492qe54IdnD7GyJ8MtLKlD21NGcQIxV8fXPuliAwPVoHOg3N57pdWyqxSY")
                                }
